...
const render_spinner = (pretEl)=>{
  ...
  `;
    pretEl.innerHTML = "";
    pretEl.insertAdjacentHTML("afterbegin", markup);
};
const showRecipes = async function() {
    try {
        const id = window.location.hash.slice(1);
        if (!id) return;
        render_spinner(recipeContainer);
        const response = await fetch(`https://forkify-api.herokuapp.com/api/v2/recipes/${id}`);
        const data = await response.json();
        console.log(data);
        if (!response.ok) throwError(response, data);
...
[
    "hashchange",
    "load"
].forEach((ev)=>window.addEventListener(ev, showRecipes));

},{"core-js/modules/es.regexp.flags.js":"gSXXb","core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","url:../img/icons.svg":"loVOp","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gSXXb":[function(require,module,exports) {
...
},{}]},["fA0o9","aenu9"], "aenu9", "parcelRequire2b54")
